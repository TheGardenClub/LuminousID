...
public class poaceaeDetails {
    ...
    private String awns = null;
    private String florets_per_spikelet = null;
    ...
    public poaceaeDetails(){

    }

    public poaceaeDetails(String species_name, String common_name, int plant_thumbnail, String family_name,
                          String growth_form, String inflorescence, String leaf_blade,
                          String awns, String florets_per_spikelet, String stem_cross_section,
                          String habitat, String notes,
        ...
        this.awns = awns;
        this.florets_per_spikelet = florets_per_spikelet;
    ...
    public String getAwns() { return awns; }

    public void setAwns(String awns) { this.awns = awns; }

    public String getFlorets_per_spikelet() { return florets_per_spikelet; }

    public void setFlorets_per_spikelet(String florets_per_spikelet) { this.florets_per_spikelet = florets_per_spikelet; }
