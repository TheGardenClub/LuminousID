...
public class juncaceaeDetails {
    ...
    public juncaceaeDetails(){

    }

    public juncaceaeDetails(String species_name, String common_name, int plant_thumbnail, String family_name,
                            String growth_form, String leaf_blade,
                            String stem_cross_section, String habitat, String notes,
