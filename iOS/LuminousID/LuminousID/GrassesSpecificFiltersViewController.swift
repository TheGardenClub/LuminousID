//
//  GrassesSpecificFiltersViewController.swift
//  LuminousID
//
...
protocol GrassesSpecificFilterProtocol{
    func filterWasSelected(filter: FilterElement)
}

class GrassesSpecificFiltersViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    var attributeName = ""
    ...
    var delegate:GrassesSpecificFilterProtocol?
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "grassesSpecificFilterCell", for: indexPath) as! ForbsSpecificCellTableViewCell
